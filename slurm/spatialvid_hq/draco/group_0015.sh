...
#SBATCH -p backfill_block1,backfill_block3,backfill_block4,backfill_singlenode,batch_block1,batch_block3,batch_block4,batch_singlenode
#SBATCH -t 04:00:00
#SBATCH -N 1
#SBATCH --gpus-per-node 8
#SBATCH --array=1-15%1
#SBATCH -J VIPE:SpatialVID-HQ-group_0015
#SBATCH -o logs/vipe_group_0015_%A_%a.out
#SBATCH -e logs/vipe_group_0015_%A_%a.err
#SBATCH --exclusive
...
# Paths
BASE_VIDEO_PATH="$MYHOME/data/SpatialVID-HQ/videos/group_0015/"
OUTPUT_PATH="$MYHOME/data/SpatialVID-HQ/vipe_results/group_0015/"

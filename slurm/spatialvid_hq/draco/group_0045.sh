...
#SBATCH --array=1-15%1
#SBATCH -J VIPE:SpatialVID-HQ-group_0045
#SBATCH -o logs/vipe_group_0045_%A_%a.out
#SBATCH -e logs/vipe_group_0045_%A_%a.err
#SBATCH --exclusive
...
# Paths
BASE_VIDEO_PATH="$MYHOME/data/SpatialVID-HQ/videos/group_0045/"
OUTPUT_PATH="$MYHOME/data/SpatialVID-HQ/vipe_results/group_0045/"
